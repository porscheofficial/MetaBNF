    ...
    <node concept="2Sbjvc" id="1nL_s$DdfTm" role="2ZfgGD">
      <node concept="3clFbS" id="1nL_s$DdfTn" role="2VODD2">
        ...
        <node concept="3clFbF" id="1nL_s$DjgTd" role="3cqZAp">
          <node concept="37vLTI" id="1_KnmTiabDX" role="3clFbG">
            <node concept="2OqwBi" id="1nL_s$DjgX1" role="37vLTJ">
              <node concept="37vLTw" id="1nL_s$DjgTb" role="2Oq$k0">
                <ref role="3cqZAo" node="1nL_s$DiMym" resolve="abstractNode" />
              </node>
              <node concept="3TrEf2" id="1_KnmTia9Zm" role="2OqNvi">
                <ref role="3Tt5mk" to="p1cl:7egTi9LqCwC" resolve="expr" />
              </node>
            </node>
            <node concept="2OqwBi" id="1_KnmTiabEA" role="37vLTx">
              <node concept="2Sf5sV" id="1_KnmTiabEB" role="2Oq$k0" />
              <node concept="3TrEf2" id="1_KnmTiabEC" role="2OqNvi">
                <ref role="3Tt5mk" to="p1cl:7egTi9LqCwC" resolve="expr" />
              </node>
            </node>
          </node>
